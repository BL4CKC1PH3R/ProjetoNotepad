...
namespace Notepad___
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            DirectoryInfo dir = new DirectoryInfo(@"C:\Temp\Notepad+++");
            dir.Create();
...
//IMPRIMIR-------------------------------------------------------------------------
        ...
        {
            SavePrint();
            string filename = @"C:\Temp\Notepad+++\imprimir.txt";
        ...
        {
            File.Delete(@"C:\Temp\Notepad+++\imprimir.txt");
        }

        private void SavePrint()
        {
            StreamWriter sw = new StreamWriter(@"C:\Temp\Notepad+++\imprimir.txt");
            sw.Write(rich_MainText.Text);
            sw.Close();
        }
//-----------------------------------------------------------------------------
        ...
        private void fecharToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Directory.Delete(@"C:\Temp\Notepad+++");
        }
